...
using ..EmeraldLand.SPAC: BETA, CNPP, ET_SOIL, ET_VEGE, GPP, LATENT_HEAT, K_PLANT, NET_LONGWAVE, NET_SHORTWAVE, OCS, SENSIBLE_HEAT
...
using ..EmeraldPhysics.Constant: M_H₂O, T₀, ρ_H₂O
