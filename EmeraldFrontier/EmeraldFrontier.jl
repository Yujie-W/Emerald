...
using ..EmeraldLand.SPAC: BETA, CNPP, GPP, PAR, PPAR, T_VEG, ΦDFNP, ΣSIF, ΣSIF_CHL, ΣSIF_LEAF, initialize!, prescribe_air!, prescribe_soil!, soil_plant_air_continuum!, update!, update_step_auxils!
