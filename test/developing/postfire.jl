...
spac_1 = EmeraldLand.Namespace.BulkSPAC(config_1);
spac_2 = EmeraldLand.Namespace.BulkSPAC(config_1);
spac_3 = EmeraldLand.Namespace.BulkSPAC(config_1);

# for i in eachindex(spac_1.airs)
#     spac_1.airs[i].auxil.wind = 0.1;
#     spac_2.airs[i].auxil.wind = 0.1;
#     spac_3.airs[i].auxil.wind = 0.1;
# end;

EmeraldLand.SPAC.prescribe_traits!(config_1, spac_1; lai=0.0, sai=0.0);
...
EmeraldLand.SPAC.initialize_spac!(config_1, spac_3);

EmeraldLand.SPAC.spac!(config_1, spac_1, FT(1));
EmeraldLand.SPAC.spac!(config_1, spac_2, FT(1));
EmeraldLand.SPAC.spac!(config_1, spac_3, FT(1));
@info "comparison" spac_1.canopy.structure.auxil.lwꜛ[1] spac_2.canopy.structure.auxil.lwꜛ[1] spac_3.canopy.structure.auxil.lwꜛ[1];


EmeraldLand.SPAC.SHORTWAVE_OUT(config_1, spac_1)



spac_2.soil_bulk.auxil.ρ_sw[config_2.SPECTRA.IΛ_PAR] .*= 0.2;
spac_3.soil_bulk.auxil.ρ_sw[config_2.SPECTRA.IΛ_PAR] .*= 0.1;

begin
    for i in 1:50000
        EmeraldLand.SPAC.spac!(config_1, spac_1, FT(10));
        EmeraldLand.SPAC.spac!(config_2, spac_2, FT(10));
        EmeraldLand.SPAC.spac!(config_2, spac_3, FT(10));
        @info "Debugging $i" spac_1.canopy.structure.auxil.lwꜛ[1] spac_2.canopy.structure.auxil.lwꜛ[1] spac_3.canopy.structure.auxil.lwꜛ[1];
        @info "Debugging $i" EmeraldLand.SPAC.NET_SHORTWAVE(spac_1) EmeraldLand.SPAC.NET_SHORTWAVE(spac_2) EmeraldLand.SPAC.NET_SHORTWAVE(spac_3);
    end;
end;
