...
@testset "Run SPAC Response to SWC" begin
    ...
    for θ in 0.09:-0.0001:0.085
        ...
        psoil = EmeraldLand.SoilHydraulics.soil_ψ_25(spac.soils[1].trait.vc, θ) * PkgUtility.PhysicalChemistry.relative_surface_tension(spac.soils[1].auxil.t);
        spac.plant.junction.state.v_storage = EmeraldLand.PlantHydraulics.capacitance_volume(spac.plant.junction.trait.pv, psoil, spac.plant.junction.auxil.t) * spac.plant.junction.trait.v_max;
        EmeraldLand.SPAC.initialize_spac!(config, spac);
