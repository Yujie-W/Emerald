...
@testset "Change SPAC PAR Definition" begin
    ...
    EmeraldLand.Namespace.t_aux!(config_uvparfr, spac_uvparfr.canopy);
    EmeraldLand.Namespace.s_aux!(config_uvparfr, spac_uvparfr.canopy);
    ...
    EmeraldLand.Namespace.t_aux!(config_paronly, spac_paronly.canopy);
    EmeraldLand.Namespace.s_aux!(config_paronly, spac_paronly.canopy);
