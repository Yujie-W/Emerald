...
@testset "Change SPAC PAR Definition" begin
    ...
    EmeraldLand.Namespace.t_aux!(config_uvparfr, spac_uvparfr);
    EmeraldLand.Namespace.s_aux!(config_uvparfr, spac_uvparfr);
    ...
    EmeraldLand.Namespace.t_aux!(config_paronly, spac_paronly);
    EmeraldLand.Namespace.s_aux!(config_paronly, spac_paronly);
