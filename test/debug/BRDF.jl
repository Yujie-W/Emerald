...
for angle in collect(FT, -89.5:0.5:89.5)
    ...
    println(angle, ",", spacs.canopy.sensor_geometry.auxil.reflectance[54], ",", spacs.canopy.sun_geometry.auxil.albedo[54], ",", space.canopy.sensor_geometry.auxil.reflectance[54], ",", space.canopy.sun_geometry.auxil.albedo[54]);
end;
