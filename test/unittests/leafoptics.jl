...
@testset verbose = true "LeafOptics.jl" begin
    ...
    @testset "Leaf interface ρ and τ" begin
        config = NS.SPACConfiguration(Float64; dataset = NS.OLD_PHI_2021_1NM);
    ...
    @testset "Leaf sublayer τ and f" begin
        ...
        bio = NS.LeafBio(config);
        LO.leaf_interface_ρ_τ!(config, bio, 40.0);
        LO.leaf_sublayer_f_τ!(config, bio, 5.0);
    ...
    @testset "Leaf layer effective interface ρ" begin
        ...
        ρ_12 = LO.effective_ρ_12.(bio.auxil.ρ_layer_1, bio.auxil.τ_layer_1, bio.auxil.τ_all_1);
        ρ_21 = LO.effective_ρ_21.(bio.auxil.ρ_layer_1, bio.auxil.τ_layer_1, bio.auxil.τ_all_1);
