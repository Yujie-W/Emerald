...
function ΦDFNP(spac::BulkSPAC{FT}) where {FT}
    ...
    for irt in 1:n_layer
        ...
        sum_ϕda += (canopy.sun_geometry.auxil.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_d_sunlit) +
                   (1 - canopy.sun_geometry.auxil.p_sunlit[irt]) * leaf.flux.auxil.a_g_shaded * leaf.flux.auxil.ϕ_d_shaded) * canopy.structure.trait.δlai[irt];
        sum_ϕfa += (canopy.sun_geometry.auxil.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_f_sunlit) +
                   (1 - canopy.sun_geometry.auxil.p_sunlit[irt]) * leaf.flux.auxil.a_g_shaded * leaf.flux.auxil.ϕ_f_shaded) * canopy.structure.trait.δlai[irt];
        sum_ϕna += (canopy.sun_geometry.auxil.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_n_sunlit) +
                   (1 - canopy.sun_geometry.auxil.p_sunlit[irt]) * leaf.flux.auxil.a_g_shaded * leaf.flux.auxil.ϕ_n_shaded) * canopy.structure.trait.δlai[irt];
        sum_ϕpa += (canopy.sun_geometry.auxil.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_p_sunlit) +
                   (1 - canopy.sun_geometry.auxil.p_sunlit[irt]) * leaf.flux.auxil.a_g_shaded * leaf.flux.auxil.ϕ_p_shaded) * canopy.structure.trait.δlai[irt];
        sum_a   += (canopy.sun_geometry.auxil.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit) +
                   (1 - canopy.sun_geometry.auxil.p_sunlit[irt]) * leaf.flux.auxil.a_g_shaded) * canopy.structure.trait.δlai[irt];
    end;
