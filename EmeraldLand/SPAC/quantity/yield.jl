...
function ΦDFNP(spac::BulkSPAC{FT}) where {FT}
    ...
    for irt in 1:n_layer
        ilf = n_layer + 1 - irt;
        leaf = leaves[ilf];
        sum_ϕda += (canopy.sun_geometry.s_aux.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_d_sunlit) +
        ...
        sum_ϕfa += (canopy.sun_geometry.s_aux.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_f_sunlit) +
        ...
        sum_ϕna += (canopy.sun_geometry.s_aux.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_n_sunlit) +
        ...
        sum_ϕpa += (canopy.sun_geometry.s_aux.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit .* leaf.flux.auxil.ϕ_p_sunlit) +
        ...
        sum_a   += (canopy.sun_geometry.s_aux.p_sunlit[irt] * mean(leaf.flux.auxil.a_g_sunlit) +
