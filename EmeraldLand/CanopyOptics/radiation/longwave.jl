...
function longwave_radiation!(spac::BulkSPAC{FT}) where {FT}
    ...
    for irt in 1:n_layer
        ...
        f_stem = 1 - f_leaf;
        can_str.auxil.lw_layer_leaf[irt] = leaf.energy.s_aux.t ^ 4 * f_leaf * K_STEFAN(FT) * can_str.auxil.ϵ_lw_layer[irt] * can_str.t_aux.ci_diffuse;
        can_str.auxil.lw_layer_stem[irt] = stem.energy.s_aux.t ^ 4 * f_stem * K_STEFAN(FT) * can_str.auxil.ϵ_lw_layer[irt] * can_str.t_aux.ci_diffuse;
