...
using ..EmeraldLand.SPAC: BETA, CNPP, GPP, PPAR, T_VEG, ΦDFNP, initialize!, soil_plant_air_continuum!, update!
...
DF_VARIABLES   = ["F_H2O", "F_CO2", "F_GPP", "BETA", "SIF683", "SIF740", "SIF757", "SIF771", "RED", "BLUE", "NIR", "NDVI", "EVI", "NIRvI", "NIRvR", "PAR", "PPAR", "ΦD", "ΦF", "ΦN", "ΦP"];
