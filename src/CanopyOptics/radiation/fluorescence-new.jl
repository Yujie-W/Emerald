...
function fluorescence_spectrum!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
    ...
    for irt in 1:n_layer
        ...
        # integrate the energy absorbed by chl (and car) in each wave length bins
        sun_geo.auxil._e_dif_sife .= view(sun_geo.auxil.e_net_dif,SPECTRA.IΛ_SIFE,irt) .* f_leaf .* SPECTRA.ΔΛ_SIFE;
        sun_geo.auxil._e_dir_sife .= view(sun_geo.auxil.e_net_dir,SPECTRA.IΛ_SIFE,irt) .* f_leaf .* SPECTRA.ΔΛ_SIFE;
        ...
        # convert the excitation radiation to fluorescence components
        mul!(sun_geo.auxil._e_dirꜜ_sifꜛ, leaf.bio.auxil.matꜛ_α, sun_geo.auxil._e_dir_sife);
        mul!(sun_geo.auxil._e_dirꜜ_sifꜜ, leaf.bio.auxil.matꜜ_α, sun_geo.auxil._e_dir_sife);
        mul!(sun_geo.auxil._e_difꜜ_sifꜛ, leaf.bio.auxil.matꜛ_α, sun_geo.auxil._e_dif_sife);
        mul!(sun_geo.auxil._e_difꜜ_sifꜜ, leaf.bio.auxil.matꜜ_α, sun_geo.auxil._e_dif_sife);
        ...
        sun_geo.auxil.e_sifꜜ_layer[:,irt] .= sun_geo.auxil._e_dirꜜ_sifꜜ .* ϕ_sunlit_dir .+
                                             sun_geo.auxil._e_difꜜ_sifꜜ .* ϕ_sunlit_dif .* sun_geo.auxil.p_sunlit[irt] .+
                                             sun_geo.auxil._e_difꜜ_sifꜜ .* ϕ_shaded .* (1 - sun_geo.auxil.p_sunlit[irt]);
        sun_geo.auxil.e_sifꜛ_layer[:,irt] .= sun_geo.auxil._e_dirꜜ_sifꜛ .* ϕ_sunlit_dir .+
                                             sun_geo.auxil._e_difꜜ_sifꜛ .* ϕ_sunlit_dif .* sun_geo.auxil.p_sunlit[irt] .+
                                             sun_geo.auxil._e_difꜜ_sifꜛ .* ϕ_shaded .* (1 - sun_geo.auxil.p_sunlit[irt]);
    end;
...
#=
    # 4. compute the fluorescence spectra at the observer direction
    for i in 1:n_layer
        e_d_i = view(sun_geo.auxil.e_sifꜜ,:,i);         # downward diffuse radiation at upper boundary
        e_u_i = view(sun_geo.auxil.e_sifꜛ,:,i);         # upward diffuse radiation at upper boundary
        ...
        sen_i .= sen_geo.auxil.p_sensor[i] .* ilai .* (dob_l .* e_d_i .+ dof_l .* e_u_i) .+ sen_geo.auxil.p_sun_sensor[i] .* ilai .* so_l .* rad_sw.e_dir .+
                 sen_geo.auxil.p_sensor[i] .* isai .* (dob_s .* e_d_i .+ dof_s .* e_u_i) .+ sen_geo.auxil.p_sun_sensor[i] .* isai .* so_s .* rad_sw.e_dir;
    end;
