...
"""
    ...
    leaf_sublayer_f_τ!(config::SPACConfig{FT}, bio::LeafBio{FT}, lwc::FT) where {FT}
...
"""
function leaf_sublayer_f_τ!(config::SPACConfig{FT}, bio::LeafBio{FT}, lwc::FT) where {FT}
    (; K_ANT, K_BROWN, K_CAB, K_CAR_V, K_CAR_Z, K_CBC, K_H₂O, K_LMA, K_PRO, Λ) = config.CONSTANTS.SPECTRA;
