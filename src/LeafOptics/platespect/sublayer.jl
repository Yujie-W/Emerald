...
function leaf_sif_matrices_new!(config::SPACConfig{FT}, bio::LeafBio{FT}, ::PlatespectFluorescenceSpectra) where {FT}
    (; IΛ_SIF, IΛ_SIFE, ΔΛ_SIF, Λ_SIF, Λ_SIFE, Φ_PS) = config.CONSTANTS.SPECTRA;
