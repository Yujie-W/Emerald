...
function prescribe_traits!(
    ...
    if !spac.plant._leaf_shedded
        prescribe_ps_traits!(config, leaves[end]; b6f = b6f, jmax = jmax, rd = rd, vcmax = vcmax, vpmax = vpmax);
        prescribe_ps_traits!(config, spac; vertical_expo = vertical_expo);
    end;
...
prescribe_ps_traits!(
            ...
            rd::Union{Nothing, Number} = nothing,
            vcmax::Union{Nothing, Number} = nothing,
            vpmax::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, leaf.photosystem.trait; b6f = b6f, jmax = jmax, rd = rd, vcmax = vcmax, vpmax = vpmax);
...
prescribe_ps_traits!(
            ...
            rd::Union{Nothing, Number} = nothing,
            vcmax::Union{Nothing, Number} = nothing,
            vpmax::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, pst, config.METHODS.C3_AC_METHOD, config.METHODS.C3_AJ_METHOD, config.METHODS.C3_AP_METHOD; b6f = b6f, jmax = jmax, rd = rd, vcmax = vcmax, vpmax = vpmax);
...
prescribe_ps_traits!(
            ...
            rd::Union{Nothing, Number} = nothing,
            vcmax::Union{Nothing, Number} = nothing,
            vpmax::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, pst, config.METHODS.C4_AC_METHOD, config.METHODS.C4_AJ_METHOD, config.METHODS.C4_AP_METHOD; b6f = b6f, jmax = jmax, rd = rd, vcmax = vcmax, vpmax = vpmax);
...
prescribe_ps_traits!(
            config::SPACConfig,
            spac::BulkSPAC;
            vertical_expo::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, spac, spac.plant.leaves[end].photosystem.trait; vertical_expo = vertical_expo);

prescribe_ps_traits!(
            config::SPACConfig,
            spac::BulkSPAC,
            pst::GeneralC3Trait;
            vertical_expo::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, spac, config.METHODS.C3_AC_METHOD, config.METHODS.C3_AJ_METHOD, config.METHODS.C3_AP_METHOD; vertical_expo = vertical_expo);

prescribe_ps_traits!(
            config::SPACConfig,
            spac::BulkSPAC,
            pst::GeneralC4Trait;
            vertical_expo::Union{Nothing, Number} = nothing) = prescribe_ps_traits!(config, spac, config.METHODS.C4_AC_METHOD, config.METHODS.C4_AJ_METHOD, config.METHODS.C4_AP_METHOD; vertical_expo = vertical_expo);
...
prescribe_ps_td!(
            ...
            t_clm::Union{Nothing, Number}) where {FT} = prescribe_ps_td!(config, config.METHODS.TD_VCMAX_C3, config.METHODS.TD_JMAX; t_clm = t_clm);
...
prescribe_ps_td!(
    ...
    if !isnothing(t_clm) && ACCLIMATE_T_VCMAX
