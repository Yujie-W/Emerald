...
"""
    ...
    step_preparations!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
...
"""
function step_preparations!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
    step_aux!(spac);
...
"""
    ...
    step_remote_sensing!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
...
"""
function step_remote_sensing!(config::SPACConfig{FT}, spac::BulkSPAC{FT}) where {FT}
