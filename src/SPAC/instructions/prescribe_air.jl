...
function prescribe_air!(
    ...
    if !isnothing(f_OCS) air.auxil.f_OCS = f_OCS; air.auxil.ps[6] = air.auxil.f_OCS * air.state.p_air * 1e-9; end;
    ...
    if !isnothing(p_OCS) air.auxil.ps[6] = p_OCS; air.auxil.f_OCS = air.auxil.ps[6] / air.state.p_air * 1e9; end;
