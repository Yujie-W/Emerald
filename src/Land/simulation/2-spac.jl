...
- `lai_layer_strategy` Whether to use LAI-based air layer strategy (default: false)

"""
function site_spac(config::SPACConfig{FT}, gmd::Union{Dict,OrderedDict}; c3c4::String = "C3", lai_layer_strategy::Bool = false) where {FT}
