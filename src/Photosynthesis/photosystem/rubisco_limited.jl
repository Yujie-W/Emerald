...
rubisco_limited_rate!(
            ...
            p_i::FT;
            β::FT = FT(1)) where {FT} = rubisco_limited_rate!(config, psa, config.METHODS.C3_AC_METHOD, p_i; β = β);
...
rubisco_limited_rate!(
            ...
            psa::LeafPhotosystemAuxil{FT},
            p_i::FT;
            β::FT = FT(1)) where {FT} = rubisco_limited_rate!(config, psa, config.METHODS.C4_AC_METHOD, p_i; β = β);
...
rubisco_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = rubisco_limited_rate!(config, ps.trait, ps.auxil, air, g_lc; β = β);
...
rubisco_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = rubisco_limited_rate!(config, psa, config.METHODS.C3_AC_METHOD, air, g_lc; β = β);
...
rubisco_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = rubisco_limited_rate!(config, psa, config.METHODS.C4_AC_METHOD, air, g_lc; β = β);
