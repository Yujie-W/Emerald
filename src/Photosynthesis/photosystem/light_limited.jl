...
light_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = light_limited_rate!(config, ps.trait, ps.state, ps.auxil, air, g_lc; β = β);
...
light_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = light_limited_rate!(config, pss, psa, config.METHODS.C3_AJ_METHOD, air, g_lc; β = β);
...
light_limited_rate!(
            ...
            air::AirLayer{FT},
            g_lc::FT;
            β::FT = FT(1)) where {FT} = light_limited_rate!(config, pss, psa, config.METHODS.C4_AJ_METHOD, air, g_lc; β = β);
