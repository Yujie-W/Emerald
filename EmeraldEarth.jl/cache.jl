...
#     2023-Apr-13: re-wire RAD_SW_REF and WLSET to CACHE_CONFIG
#
#######################################################################################################################################################################################################
"""

    synchronize_cache!(gm_params::Dict{String,Any}, wd_params::Dict{String,Any}, state::Union{Nothing,MultiLayerSPACState{FT}}) where {FT}
