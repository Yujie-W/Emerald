...
β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, sm::AbstractStomataModel{FT}) where {FT,DIM_XYLEM} = nothing;

β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, sm::Union{BallBerrySM{FT}, GentineSM{FT}, LeuningSM{FT}, MedlynSM{FT}}) where {FT,DIM_XYLEM} =
    β_factor!(roots, soil, leaves, sm.β);

β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}) where {FT,DIM_XYLEM} = β_factor!(roots, soil, leaves, β, β.PARAM_X);

β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}, param_x::BetaParameterKleaf) where {FT,DIM_XYLEM} = (
...
β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}, param_x::BetaParameterKsoil) where {FT,DIM_XYLEM} = (
...
β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}, param_x::BetaParameterPleaf) where {FT,DIM_XYLEM} = (
    _f_st = relative_surface_tension(leaves.t);
...
β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}, param_x::BetaParameterPsoil) where {FT,DIM_XYLEM} = (
    # weigh the beta by root Kmax for the roots with positive flow
    _norm = 0;
    _deno = 0;
    _sumf = 0;
...
β_factor!(roots::Vector{Root{FT,DIM_XYLEM}}, soil::Soil{FT}, leaves::Leaves2D{FT}, β::BetaFunction{FT}, param_x::BetaParameterΘ) where {FT,DIM_XYLEM} = (
    # weigh the beta by root Kmax for the roots with positive flow
    _norm = 0;
    _deno = 0;
    _sumf = 0;
